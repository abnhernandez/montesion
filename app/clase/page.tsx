...
export default function ClasesPremiumLanding() {
  return (
    <section className="w-full min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-20 lg:px-32 py-20">
      <div className="flex-1 max-w-2xl md:mr-16">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
          ...
          <span className="inline-block align-middle ml-3">
            <span className="bg-yellow-300 text-xs font-bold px-3 py-1 rounded-lg align-middle">BETA</span>
          </span>
        </h1>
